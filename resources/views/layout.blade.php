...
<head>
    ...
    <script>
        jQuery(document).ready(function($){
            ...
            $('.form-search').on('ajax:success', function(e,data) {
...
<body>
    ...
    <div class="container">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 content" style="padding-right:0">
            <div class="container-fluid">
                @include('flash::message')
                @include('_partials.error_list')
